...
public abstract class PersonnageEquipe extends Personnage{
	...
	public boolean equals(Object obj){
		return obj instanceof PersonnageEquipe pe
			&& getClass().isAssignableFrom(pe.getClass())
			&& personnage.equals(pe.personnage);
	}
	@Override
	public int hashCode(){
		return getClass().getSimpleName().hashCode() + personnage.hashCode();
	}
